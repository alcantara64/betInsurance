...
include "controllers/con_login_admin.php";
...
if (isset($_POST['email']) && isset($_POST['password'])) {
    ...
    $obj1 = new con_login_admin();
    $obj1->confirmLogin_admin($email, $password);
...
<html lang="en">
    <a href=""></a>
<head>
        <title>Tukoolbetinsurance admin</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="post" action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>">
